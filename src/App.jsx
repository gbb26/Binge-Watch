...
import DetailsTvCard from "./components/Cards/DetailsTvCard";

const data = {
  adult: false,
  backdrop_path: "/qMsbXoFEzqsCZxA8i4szTPLw64d.jpg",
  ...
  production_companies: [
    ...
    {
      id: 174,
      logo_path: "/mYQTePYbpYNIe2aHgwicJwERAim.png",
    ...
    <div className="main" style={{ display: "flex" }}>
      ...
      <Routes>
        ...
        <Route
          exact
          path="/movie-details"
          element={<DetailsMovieCard movieDetails={data} />}
        />
        <Route
          exact
          path="/tv-details"
          element={<DetailsTvCard tvSeriesDetails={tvData} />}
        />
      </Routes>
    </div>
  );
